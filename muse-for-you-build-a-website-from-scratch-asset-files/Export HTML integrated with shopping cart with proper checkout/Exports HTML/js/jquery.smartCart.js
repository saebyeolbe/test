;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive float-left" src="{product_image}" /><h4 class="list-group-item-heading">{product_name}</h4><p class="list-group-item-text">{product_desc}</p>',
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.addClass('card sc-cart sc-theme-' + this.options.theme);
            this.cart_element.append('<div class="card-header sc-cart-heading">' + this.options.lang.cartTitle + ' <span class="sc-cart-count badge badge-info">0</span></div>');
            this.cart_element.append('<div class="list-group list-group-flush sc-cart-item-list"></div>');
        },
        /* 
        ...
        _setToolbar: function () {
            ...
            var toolbar = $('<div></div>').addClass('card-body sc-toolbar');
